...
import { ramaTxRequestConfigToWeb3 } from "@ramestta/rama-web3";
import { ITransactionRequestConfig, ABIManager } from "@ramestta/ramajs";
...
describe('ERC20', () => {
    ...
    it('check for config props', async () => {
        ...
        const config = ramaTxRequestConfigToWeb3(txConfig);
